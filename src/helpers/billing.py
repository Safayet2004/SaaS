...
def serialize_subscription_data(subscription):
...
def get_checkout_customer_plan(session_id):
    ...
    subscription_id = checkout_r.subscription.id

    subscription = stripe.Subscription.retrieve(subscription_id)

    sub_plan = subscription.plan
    subscription_data = serialize_subscription_data(subscription)

    data = {
        "customer_id": customer_id,
        "plan_id": sub_plan.id,
        "sub_stripe_id": subscription.id,
       **subscription_data,
    }
    return data